...
def create_parser():
    ...
    parser.add_argument('-tc', '--temporal-coherence', dest='temporalcoherence_file', required=True, 
                        help='Temporal coherence/correlation file, i.e. temporalCoherence.h5')
    parser.add_argument('-asc', '--average-spatial-coherence', dest='avgspatialcoherence_file', required=True,
