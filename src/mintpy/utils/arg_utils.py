...
def add_gnss_argument(parser):
    ...
    gnss.add_argument('--gnss-ms', dest='gnss_marker_size', type=float, default=6,
    ...
    gnss.add_argument('--gnss-comp', dest='gnss_component',
                     ...
                     help='Plot GNSS in color indicating deformation velocity direction')
    ...
    gnss.add_argument('--ref-gnss', dest='ref_gnss_site', type=str, help='Reference GNSS site')
    gnss.add_argument('--ex-gnss', dest='ex_gnss_sites', type=str, nargs='*',
    ...
    gnss.add_argument('--gnss-start-date', dest='gnss_start_date', type=str, metavar='YYYYMMDD',
                     help='start date of GNSS data, default is date of the 1st SAR acquisition')
    gnss.add_argument('--gnss-end-date', dest='gnss_end_date', type=str, metavar='YYYYMMDD',
                     help='start date of GNSS data, default is date of the last SAR acquisition')
    gnss.add_argument('--horz-az','--hz-az', dest='horz_az_angle', type=float, default=-90.,
