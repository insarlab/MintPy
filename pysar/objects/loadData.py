...
def create_parser():
    ...
    parser = argparse.ArgumentParser( description='saving a stack of InSAR pairs to an HDF5 file')
...
def write2h5(inps):
    ...
    for dir in dirs:
        ...
        pairObj = insarPair(dates=(Time1 , Time2) ,observation = obsDict, quality = qualityDict, geometry=geometryDict, metadata=metadataDict)
