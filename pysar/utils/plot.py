...
from pysar.utils import datetime as ptime, network as pnet, utils as ut
...
def plot_network(ax, date12List, dateList, pbaseList, plot_dict={}, date12List_drop=[], printMsg=True):
