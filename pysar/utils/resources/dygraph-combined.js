...
DygraphRangeSelector.prototype.resize_ = function () {
    ...
    this.canvasRect_ = {x: c.x, y: c.y + c.h + b + 4, w: c.w, h: this.attr_("rangeSelectorHeight")};
...
Dygraph.getDateAxis = function (n, h, a, l, y) {
    ...
    if (a < Dygraph.MONTHLY) {
        ...
        n = z.getTime();
        for (var k = n; k <= h; k += c) {
            A.push({v: k, label: u(new Date(k), a, l, y)})
        }
    } else {
        var e;
        var o = 1;
