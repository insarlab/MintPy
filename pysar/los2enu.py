...
*************************************************************************
  ...
  Usage:
       ...
       los2enu.py -f  LOS file  -c Components [ -i incidence angle file] [-F 'fault coordinates'] [-a azimuth] [-H heading]
       ...
       -c : [E, N, U, H, Fpar]
            ...
            Fpar : Projecting LOS to Fault Parallel , assuming zero Up component (This needs the azimuth of the fault or the  coordinates of two points on the fault )
  ...
  if component in 'U, u, Up, up, uP':
      ...
      # h=346.8921*pi/180.
       ...
       try:
          ...
          print 'Error: los option projects the current los to a different los with a given inc angle. It needs the new inc angle to be introdueced using -I option'
          sys.exit(1)
       inc=inc-proj_inc
       P = V*cos(inc) # projecting LOS to up assuming zero horizontal deformation
