...
from pysar.utils import readfile, writefile, datetime as ptime, utils as ut, network as pnet, plot as pp
...
def main(argv):
    ...
    ifgram_list_keep = ut.check_drop_ifgram(h5, printMsg=False)
